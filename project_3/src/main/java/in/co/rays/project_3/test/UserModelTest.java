...
public class UserModelTest {
	...
	private static void findByLoginTest() throws ApplicationException {
		...
		UserDTO dto = model.findByLogin("patidarpankaj6232@gmail.com");
	...
	public static void addTest() throws Exception {
		...
		dto.setLogin("jbjkn.vipin02@gmail.com");
		dto.setGender("male");
		...
		dto.setRegisteredIP("02@gmail.com");
		dto.setLoginIP("jbjkn.vipin02@gmail.com");
