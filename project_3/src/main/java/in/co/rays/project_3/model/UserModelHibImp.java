...
public class UserModelHibImp implements UserModelInt {
	...
	public void update(UserDTO dto) throws ApplicationException, DuplicateRecordException {
		...
		// Check if updated College already exist
		  ...
		  DuplicateRecordException("Login Id is Already Exist"); }
	...
	/**
	 * search record from database with email id
	 */
	...
	/**
	 * authenticate user with emailid and password
	 */
	...
	/**
	 * get your password in your emailid
	 */
