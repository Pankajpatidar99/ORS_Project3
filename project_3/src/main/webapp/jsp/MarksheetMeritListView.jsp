...
.p4 {
	background-image: url('<%=ORSView.APP_CONTEXT%>/image/img22.jpg');
...
<body class="p4">
	...
	<div>
		<form action="<%=ORSView.MARKSHEET_MERIT_LIST_CTL%>" method="post">
			...
			<div align="center">
				<h1 class="text-light font-weight-bold">Marksheet Merit List</h1>
			</div>
		...
		<b>
			<table class="table table-responsive">
				<table class="table table-info table-bordered table-hover"
					style="background-image: url('<%=ORSView.APP_CONTEXT%>/img/avatar-g92feff2a2_1920.webp');">
					<thead>
