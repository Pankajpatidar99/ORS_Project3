...
<body>
	...
	%>
	<div class="header">
		<nav class="navbar navbar-expand-lg fixed-top raj "
			style="background-color: rgba(125, 135, 149, 0.6)"> <a
						...
						<li class="nav-item dropdown" style="padding-left: 5px;"><a
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="<%=ORSView.USER_CTL%>"><i
									class="fas fa-user-circle"></i>Add User</a> <a
						...
						<li class="nav-item dropdown" style="padding-left: 5px"><a
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="<%=ORSView.FACULTY_CTL%>"><i
									class="fas fa-user-tie"></i>Add Faculty</a> <a
						...
						<li class="nav-item dropdown" style="padding-left: 5px"><a
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="<%=ORSView.SUBJECT_CTL%>"><i
									...
									class="dropdown-item" href="<%=ORSView.SUBJECT_LIST_CTL%>">
									<i class="fas fa-sort-amount-down"></i>Subject List
								</a>
							</div></li>
